    ...
    return (
        <nav className="relative z-20 flex items-center justify-between px-6 py-5 md:px-10">
            ...
            {user ? (
                <button
                    onClick={logoutUser}
                    className="hidden rounded-full border border-white/10 bg-white/5 px-5 py-2.5 text-sm font-medium text-white transition-all hover:border-white/20 hover:bg-white/10 md:block"
                >
                    Logout
                </button>
            ) : (
