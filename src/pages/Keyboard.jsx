...
export default function Keyboard() {
    ...
    const allShortcuts = apps.flatMap((app) =>
            ...
            <section className="mx-auto flex h-[calc(100vh-88px)] max-w-7xl flex-col px-6 pb-6">
                <div className="shrink-0 pt-4">
                    <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
                        ...
                        <button
                            onClick={clearKeys}
                            className="w-fit rounded-full border border-[var(--border)] bg-[var(--surface)] px-5 py-3 text-sm text-[var(--text)] transition-colors hover:bg-[var(--surface-soft)]"
                        >
                            Clear keys
                        </button>
                    </div>
